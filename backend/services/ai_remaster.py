...
REMASTER_ANALYSIS_PROMPT = (
    ...
    "black-and-white. For every person, describe ONLY what is clearly visible in the image — "
    "their exact clothing (necklines, collars, sleeves, buttons, hems, patterns, fit) and ONLY "
    "accessories that are clearly visible (flowers, pins, jewellery, hats, bouquets, boutonnières). "
    "Do NOT infer, assume, or add any item that is not clearly visible — if you cannot see it, "
    "it does not exist. Catalog every prop and background element that is clearly visible. Note "
    "the lighting direction, tonal range, and any age-related degradation (grain, fading, "
    "cracks, colour shift). This inventory is your ground truth — nothing may be added, removed, "
    "or changed.\n\n"
    ...
    "but change NOTHING about the subjects, their clothing, or the scene. Do NOT add any "
    "accessories, clothing items, belts, tools, pens, or objects that are not clearly visible "
...
REMASTER_GENERATION_PREFIX = (
    ...
    "- Nothing may be invented — if an item is not clearly visible in the reference image, it must NOT appear in the output\n\n"
    ...
    "DO NOT: add new people, objects, or background elements. Do NOT invent or add any "
    "accessories, belts, pens, tools, bags, or items not clearly visible in the reference — "
    "if it is not in the original, it must not appear. Do NOT change clothing details, colours, "
    "or patterns. Do NOT alter faces or expressions. Do NOT remove any accessories or props "
    "visible in the reference. Do NOT reframe or crop. Do NOT replace the background.\n\n"
